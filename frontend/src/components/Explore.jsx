...
const Explore = () => {
  ...
  return (
    <div className="flex max-w-5xl justify-center mx-auto pl-20 laptop:max-w-2xl tablet:max-w-xl tablet:ml-[15%] mobile:-ml-[20%] mobile:max-w-5xl mobile:mt-[30%] laptop:ml-[17%]">
